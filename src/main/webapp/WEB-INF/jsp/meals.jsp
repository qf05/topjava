...
<section>
    ...
    <hr/>
    <a href="meals/createForm"><spring:message code="meal.add"/></a>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="meal.date"/></th>
            <th><spring:message code="meal.discription"/></th>
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExceed="${meal.exceed}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/updateForm?id=${meal.id}"><spring:message code="meal.update"/></a></td>
